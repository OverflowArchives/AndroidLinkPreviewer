...
public class WhatsappPreview extends RelativeLayout {
    ...
    public WhatsappPreview(Context context) {
        super(context);
        this.context = context;
    }

    public WhatsappPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public WhatsappPreview(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public WhatsappPreview(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
