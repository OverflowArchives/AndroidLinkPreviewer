...
public class PlainLinkPreview extends RelativeLayout {
    ...
    public PlainLinkPreview(Context context) {
        super(context);
        this.context = context;
    }

    public PlainLinkPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public PlainLinkPreview(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PlainLinkPreview(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void initView() {
        if(findLinearLayoutChild() != null) {
            ...
            this.view = this;
            inflate(context, R.layout.plain_link_layout,this);
        }

        linearLayout = (LinearLayout) findViewById(R.id.whatsapp_preview_link_card);
        imageView = (ImageView) findViewById(R.id.whatsapp_preview_link_image);
        textViewTitle = (TextView) findViewById(R.id.whatsapp_preview_link_title);
        textViewDesp = (TextView) findViewById(R.id.whatsapp_preview_link_desc);
        textViewUrl = (TextView) findViewById(R.id.whatsapp_preview_link_url);
